...
| Diversify     |        | [Variegate][]                                                  |                                                                                           |                                                                                                    |                                                                                          |
| Harden/Assure | TFPGA? | [Mnemosyne][]                                                  | [A-CERT][], [Proteus][], [REAFFIRM][]                                                     | [AMBER][], [ARTCAT][], [ConfINE][], [SySense][], [To-Static][], [Binary-Reduce][], [Stack-Stamp][] | [A-CERT][], [Proteus][], [REAFFIRM][], [To-Static][], [Binary-Reduce][], [Stack-Stamp][] |
| Assess        |        |                                                                | [A-CERT][], [Discover][], [Mnemosyne][], [Proteus][], [REAFFIRM][]                        | [AMBER][], [ARTCAT][], [ConfINE][], [SySense][], [DDisasm][], [TBDC][]                             | [A-CERT][], [Bin2Math][], [Discover][], [Proteus][], [REAFFIRM][], [DDisasm][], [TBDC][] |
