...
%%   \node[repo, above=1em of redact] (sys-enforce) {SysEnforce};
  ...
  \node[repo, below=20em of gtirb-server] (vscode) {GTIRB VSCode};
...
%%   \node[repo, below=1em of libsweep] (libmatch) {libmatch};
  ...
  %% Connections
  %% libfilter, sysfilter
  \foreach \repo in {to-static, stack-stamp, redact, devirt, pgo, peephole, lep, twit, asan, viz, delta, shuffle}{
